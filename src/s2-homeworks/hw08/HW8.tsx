...
const initialPeople: UserType[] = [
  ...
  { _id: 0, name: "Макаров Михаил", age: 3 },
  { _id: 1, name: "Тимошин Роман", age: 66 },
  { _id: 2, name: "Бориславов Макс", age: 16 },
  { _id: 3, name: "Аладинов Антон", age: 44 },
  { _id: 4, name: "Калиничев Дмитрий", age: 40 },
  { _id: 5, name: "Асеева Ирина", age: 55 },
];
